...
This public repository is limited to files required to serve the website, including the HTML entry point, public-facing assets, public metadata, the taxon index, reference data used by the website, and sanitized taxon-profile JSON.

It intentionally does **not** contain internal curation SOPs, QA ledgers, migration scripts, Notion-derived provenance, internal taxonomic name-usage identifiers, or other research-infrastructure files.
